...
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { FIR }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { OVER }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { DELAY }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { cpu_rstn }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
...
create_generated_clock -name clk_div_ss_display/clk_out -source [get_ports CLK100MHZ] -divide_by 1 [get_pins clk_div_ss_display/clk_out_reg/Q]